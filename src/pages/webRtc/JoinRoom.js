    ...
    <>
      <div className="flex flex-col lg:flex-row h-screen overflow-hidden">
        <div className="flex flex-col lg:w-3/4 w-full">
          <div className="flex-grow flex justify-center items-center bg-gray-900 overflow-y-auto">
            {!isRoomCreated && (
                ...
                <div className="space-y-2" id="registernow">
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      className="flex-grow p-1 border rounded bg-gray-200 text-gray-700"
                      id="roomname"
                      readOnly
                    />
                  </div>
        ...
        <div className="w-full lg:w-1/4 p-1 lg:p-2 bg-gray-800 flex flex-col h-full">
          ...
          <div className="flex-grow bg-gray-700 p-2 lg:p-4 rounded-lg overflow-y-auto" style={{ maxHeight: '55vh' }}>
