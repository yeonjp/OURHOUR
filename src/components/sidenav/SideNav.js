...
function SideNav() {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-800 text-white"> {/* h-full로 변경 */}
      <div className="flex-grow space-y-3">
        ...
        <div className="flex-1">
          <ul className="pt-2 pb-0 space-y-1 text-sm sm:text-base md:text-lg lg:text-xl">
            <li className="hover:bg-gray-950">
              <Link to="/mypage" className="flex items-center p-2 space-x-3 rounded-md w-full">
                <i className="fa fa-user text-white text-2xl pr-1 pt-1 float-right"></i> <span className="text-white">{t("myPageProfile")}</span>
              </Link>
            </li>
            <li className="hover:bg-gray-950">
