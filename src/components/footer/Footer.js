...
function Footer() {
  ...
  return (
    <footer className="flex flex-col lg:flex-row justify-between bg-gray-900 text-white p-1 lg:p-2 relative z-2 mt-0"> {/* mt-0로 변경 */}
      <div className="footer-left text-left mb-0 lg:mb-0 text-xxxs sm:text-xxs md:text-xs lg:text-sm overflow-x-auto whitespace-nowrap">
